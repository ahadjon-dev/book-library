export const en = {
  ...
  shelfScanner: {
    ...
    adjustTitle: "Adjust & Crop Bookshelf",
    adjustSubtitle: "Drag handles to resize width & height, rotate, or frame the book spines you want to scan.",
    zoom: "Zoom",
    rotate: "Rotate",
    reset: "Reset",
    aspectFree: "Free",
    aspectFull: "Full Photo",
    aspect16_9: "16:9",
    aspect1_1: "1:1 Square",
    changePhoto: "Change Photo",
    confirmAndScan: "Confirm & Scan",
    scanningButton: "Scanning…",
    scanning: "Reading book spines with Gemini Vision & enriching metadata…",
    ...
    notConfigured: "AI Shelf Scanner is not configured on server (GEMINI_API_KEY required).",
  },
  shareShelf: {
